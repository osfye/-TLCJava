...
//        register.getRegister().forEach(System.out::println); //print out the names of all the registered students
        ...
        Assertions.assertEquals(4, register.getRegister().size()); //check whether we have four names in our register
...
//        List<String> studentNames = register.getRegisterByLevel(Level.HUNDRED);// this method has been changed to return a map
    ...
    void getStudent() throws Exception {
        ...
        Assertions.assertEquals("Enock Boadi-Ansah",register.getStudent("Enock Boadi-Ansah"));
    }
    ...
    void getOverAllHighestGrade() {
        ...
        Assertions.assertEquals(7, register.getOverAllHighestGrade());
    }
    ...
    void getOverAllAverageGrade() {
        ...
        Assertions.assertEquals(4.55, register.getOverAllAverageGrade());
    }
    ...
    void getGradesAboveSixty() {
        ...
        Assertions.assertEquals(88.1, register.getGradesAboveSixty().get(0));
    }
